...
ALTER TABLE people ADD COLUMN IF NOT EXISTS is_soldier boolean NOT NULL DEFAULT false;
...
BEGIN
  ...
  INSERT INTO people (
    ...
    maiden_name, family_position, gender, parent_id, generation,
  ...
  VALUES (
    ...
    p_maiden_name, p_family_position, p_gender, p_parent_id, p_generation,
...
BEGIN
  ...
  INSERT INTO people (
    full_name, nickname, birth_date_gregorian, birth_date_hebrew, residence, phone, email,
    maiden_name, family_position, gender, parent_id, created_by, claimed_by,
    marital_status, honorific, is_soldier, spouse_name
  )
  VALUES (
    p_full_name, p_nickname, p_birth_date_gregorian, p_birth_date_hebrew, p_residence, p_phone, p_email,
    p_maiden_name, p_family_position, p_gender, parent_id, p_user_id, p_user_id,
    p_marital_status, p_honorific, COALESCE(p_is_soldier, false), p_spouse_name
  )
  RETURNING * INTO result;
